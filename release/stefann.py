...
with open('/Users/jongbeomkim/Desktop/workspace2/stefann/release/appdata.json', 'r') as fp:
...
try:
    ...
    with open("/Users/jongbeomkim/Desktop/workspace2/stefann/release/models/fannet.json", 'r') as fp:
        NET_F = model_from_json(fp.read())
    # with open('models/colornet.json', 'r') as fp:
    with open("/Users/jongbeomkim/Desktop/workspace2/stefann/release/models/colornet.json", 'r') as fp:
        NET_C = model_from_json(fp.read())
    
    # NET_F.load_weights('models/fannet_weights.h5')
    # NET_C.load_weights('models/colornet_weights.h5')
    NET_F.load_weights("/Users/jongbeomkim/Desktop/workspace2/stefann/release/models/fannet_weights.h5")
    NET_C.load_weights("/Users/jongbeomkim/Desktop/workspace2/stefann/release/models/colornet_weights.h5")
except:
    RUN_FLAG = False
...
class GUI(QMainWindow):
    ...
    def move_window_to_center(self):
        ...
        screen_cent = QGuiApplication.primaryScreen().availableGeometry().center()
    ...
    while RUN_FLAG:
        ...
        while step == 1:
            ...
            if key == 27:
                ...
                image_orig = cv2.bitwise_not(image_orig)
                EVER_INVERTED = True

            if EVER_INVERTED:
                image_scaled = image_orig
        ...
        while step == 2:
            ...
            if key == 27:
                ...
                image_mask = binarize(image_gray, points, thresh, 255, invert)
                # Image.fromarray(image_mask).show()
                contours, bndboxes = find_contours(image_mask, cntmin)
            elif key == 9:
